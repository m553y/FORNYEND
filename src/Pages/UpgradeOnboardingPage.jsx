import onboardingUpgrade from "../assets/image2.png";
...
export default function UpgradeOnboardingPage({ onNext, onGoToPage }) {
  return (
    <main className="relative flex min-h-screen flex-col overflow-hidden bg-[#f7f7f8]">
      <div className="flex h-[48vh] min-h-[18rem] items-end justify-center px-4">
        <img
          src={onboardingUpgrade}
          alt="Upgrade Your Car Experience"
